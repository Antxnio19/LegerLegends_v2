...
-- Hashed password for user 1: $2y$10$SKXO3TzwiR2A6CkkaaHUcetqi4S5mOFc/h.dIafbIiYBh0an4HeCm
-- Hashed password for user 2: $2y$10$PbtJ8UH9jWnvU62qXHG48.qHzbrFvq1JY7KdBSbl9FgLpMSv0rfey
-- Hashed password for user 3: $2y$10$fpkTbB1k.mSQaEDmWiXNReSpS1fh2URaiy2Y5igHos2aHI3eFS/N6
-- Hashed password for user 4: $2y$10$gX6gbVy3/IrAg82LTlNJMOSYnKM4Y8AU/K1pYMf6/bb6lnXbxrjge
-- Hashed password for user 5: $2y$10$oMBBc9fdYJHKkKiuzoIB../FI43m.tDKu98CI97af2XUSinxPFn7a
...
('3', 'maryjohnson', '$2y$10$gX6gbVy3/IrAg82LTlNJMOSYnKM4Y8AU/K1pYMf6/bb6lnXbxrjge', 'maryjohnson@example.com', '1996-04-04', 'Mary', 'Johnson', '126 Main St'),
('4', 'davidbrown', '$2y$10$oMBBc9fdYJHKkKiuzoIB../FI43m.tDKu98CI97af2XUSinxPFn7a', 'davidbrown@example.com', '1998-05-05', 'David', 'Brown', '127 Main St');
