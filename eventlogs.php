...
// Query to select all events from user_eventlog
$sql = "SELECT * FROM user_eventlog";
                ...
                if ($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        echo '<tr>
                                ...
                                <td>' . htmlspecialchars($row['TimeOfChange']) . '</td>
                                <td>' . htmlspecialchars($row['AcctAffected']) . '</td>
                                <td>' . htmlspecialchars($row['BeforeChange']) . '</td>
                                <td>' . htmlspecialchars($row['AfterChange']) . '</td>
