...
$sql = "SELECT lt.reference_number, lt.transaction_date, lt.description, lt.debit, lt.credit, lt.balance_after, ca.account_name
        ...
        WHERE lt.client_account_id = ? AND je.is_approved = 'Approved'"; // Check for approved status
...
if (!empty($accountName)) {
    $sql .= " AND ca.account_name LIKE ?"; // Change to reference account_name in Client_Accounts
}
...
<div class="main-bar">
    ...
    <br/>
    <div class="dropdown">
            <a href="manager_view_all_client_accounts.php?account_id=<?php echo $client_account_id; ?>" class="nav-link">Go to Chart of Accounts</a>
            <a href="manager_View_some_accounts.php?account_id=<?php echo $client_account_id; ?>" class="nav-link">Go to Accounts</a>
        </div>
</body>
</html>
